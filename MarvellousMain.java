    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == SUBMIT)
        {
            if(validate(value1,value2) == false)
            {
                text1.setText("");
                text2.setText("");
                JOptionPane.showMessageDialog(this,"Short username","Marvellouse Packer Unpacker",JOptionPane.ERROR_MESSAGE);   
            }
            ...
            else
            {
                ...
                if(attemp == 0)
                {
                    JOptionPane.showMessageDialog(this,"Number Of Attempt Finished","Marvellouse Packer Unpacker",JOptionPane.ERROR_MESSAGE);
                    this.dispose(); // same work of system.exit(0);
                    System.exit(0);
                }
...
class MarvellousMain
{
    public static void main(String arg[])
    {
        try
        {
            MarvellouseLogin frame = new MarvellouseLogin();
